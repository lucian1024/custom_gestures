...
class UpwardDragGestureRecognizer extends DragGestureRecognizer {
  ...
  @override
  String get debugDescription => 'vertical upward drag';
}

/// Recognizes movement in the vertical downward direction.
///
/// Used for vertical downward scrolling.
///
/// See also:
///
...
class DownwardDragGestureRecognizer extends DragGestureRecognizer {
  ...
  @override
  String get debugDescription => 'vertical downward drag';
}

/// Recognizes movement in the horizontal left direction.
///
/// Used for horizontal left scrolling.
///
/// See also:
///
///  * [UpwardDragGestureRecognizer], for a similar recognizer but for
...
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class LeftDragGestureRecognizer extends DragGestureRecognizer {
  ...
  @override
  String get debugDescription => 'horizontal left drag';
}

/// Recognizes movement in the horizontal right direction.
///
/// Used for horizontal right scrolling.
///
/// See also:
///
///  * [UpwardDragGestureRecognizer], for a similar recognizer but for
...
///  * [MultiDragGestureRecognizer], for a family of gesture recognizers that
///    track each touch point independently.
class RightDragGestureRecognizer extends DragGestureRecognizer {
  /// Create a gesture recognizer for interactions in the horizontal axis.
  ///
  /// {@macro flutter.gestures.GestureRecognizer.kind}
  ...
  @override
  String get debugDescription => 'horizontal right drag';
}